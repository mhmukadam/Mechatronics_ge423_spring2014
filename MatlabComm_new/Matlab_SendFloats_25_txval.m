function varargout = Matlab_SendFloats_25_txval(varargin)
% Matlab_SendFloats_25_txval MATLAB code for Matlab_SendFloats_25_txval.fig
%
...
% Edit the above text to modify the response to help Matlab_SendFloats_25_txval

% Last Modified by GUIDE v2.5 10-May-2014 19:18:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Matlab_SendFloats_25_txval_OpeningFcn, ...
    'gui_OutputFcn',  @Matlab_SendFloats_25_txval_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before Matlab_SendFloats_25_txval is made visible.
function Matlab_SendFloats_25_txval_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Matlab_SendFloats_25_txval (see VARARGIN)

global DataArr;
DataArr=[];

handles.TCPIP.numFloats=36; %change if you want to send more floats
...
hold on
handles.myMaze=imagesc([6,-6],[12,-7],zeros(17,13));
...
handles.Plotting.OBalls=plot(handles.axes1,[-1]);
handles.Plotting.BBalls=plot(handles.axes1,[-1]);
handles.Plotting.OBallsloc=plot(handles.axes1,[-1]);
handles.Plotting.BBallsloc=plot(handles.axes1,[-1]);
...
% Choose default command line output for Matlab_SendFloats_25_txval
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Matlab_SendFloats_25_txval wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Matlab_SendFloats_25_txval_OutputFcn(hObject, eventdata, handles)
...
function edt_vrefvalue_Callback(hObject, eventdata, handles)
% hObject    handle to edt_vrefvalue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edt_vrefvalue as text
%        str2double(get(hObject,'String')) returns contents of edt_vrefvalue as a double


% --- Executes during object creation, after setting all properties.
function edt_vrefvalue_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edt_vrefvalue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edt_turnvalue_Callback(hObject, eventdata, handles)
% hObject    handle to edt_turnvalue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edt_turnvalue as text
%        str2double(get(hObject,'String')) returns contents of edt_turnvalue as a double


% --- Executes during object creation, after setting all properties.
function edt_turnvalue_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edt_turnvalue (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in pb_sendvref.
function pb_sendvref_Callback(hObject, eventdata, handles)
% hObject    handle to pb_sendvref (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
str_vel= get(hObject,'String');
%val = get(hObject,'Value');
vel_string=get(handles.edt_vrefvalue,'String');
%V_value=get(handles.edt_vrefvalue,'Value');
vref = char(vel_string);
stop(handles.TCPIP.writeOutTimer)
handles.TCPIP.txmsg=num2str(vref);
display(vref);
set(handles.TCPIP.writeOutTimer,'TimerFcn',{'writeOutData_25',hObject,handles})
start(handles.TCPIP.writeOutTimer)


% --- Executes on button press in pb_sendturn.
function pb_sendturn_Callback(hObject, eventdata, handles)
% hObject    handle to pb_sendturn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
str_turn = get(hObject,'String');
%val = get(hObject,'Value');
turn_string=get(handles.edt_turnvalue,'String');
%V_value=get(handles.edt_turnvalue,'Value');
turn = char(turn_string);
stop(handles.TCPIP.writeOutTimer)
handles.TCPIP.txmsg=num2str(turn);
display(turn);
set(handles.TCPIP.writeOutTimer,'TimerFcn',{'writeOutData_25',hObject,handles})
start(handles.TCPIP.writeOutTimer)
